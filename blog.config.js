...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '搞oc,万劫不复',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '枯杉叶', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '不值钱的痛苦就算了', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kushanye.top', // 网站地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'false', // 分享的服務，按顺序显示,逗号隔开
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'madhouse',
      artist: ' Matt Maltese',
      url: '//music.163.com/outchain/player?type=2&id=1468381661&auto=1&height=66',
      cover:
            'https://p1.music.126.net/HfS4vI-hYN1fIw7Xm1Doog==/109951166987300822.jpg?param=130y130'
    },
    {
      name: '王都グランセル',
